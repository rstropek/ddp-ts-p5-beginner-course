...
This chapter adds a new shape to your kit: a piece of a circle. You'll use it to draw a smiley face in the middle of the canvas, with two eyes made from shapes you already know and a mouth that is a real curved smile, a single slice of a circle rather than a full one. That curve is the piece you couldn't draw before.
...
its mouth is an arc. Typing first and experimenting afterward is on
...
## AI tutor {#sec-tutor-arcs-smiley}

`arc` is the trickiest command in this part, and its start and end angles
confuse almost everybody at first. The AI tutor of this part is a good place to
ask why a certain pair of angles draws the piece it draws.
...
Nobody does it that way, professionals included. The way to understand a
command like this is to experiment with it:
