...
`helper`, `thing`, or `stuff` for everything else, because the
naming rules from the Variables part (@sec-const-naming) still
apply.
:::
...
technique is yours now, and it helps with every loop in this part
and beyond.
:::
