...
The loop computes both endpoints of every fan line from the
counter `i`.
...
Three points describe your fan's curve, and you can point at all
three in your own program:
...
p5.js `bezier` command draws cubic curves, and so does the design
program Inkscape.
...
Two details matter before you type the next program.
...
This is the finale of the Loops part. You take the row recipe
...
2. **Write the prompt.** Describe your pattern precisely, because
   the AI gives you what you say, not what you mean. Say that you
