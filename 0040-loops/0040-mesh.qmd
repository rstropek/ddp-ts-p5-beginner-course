...
and the inner loop runs zero times. The rule: the inner loop
variable is initialized *inside* the outer loop's body, so every fan
starts fresh. Once your own mesh runs, produce this bug on purpose;
