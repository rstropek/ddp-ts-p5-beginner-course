...
functions as `round` and `min`. It draws nothing and only computes a value
for you.
...
rectangle stays centered on the canvas, responsive as always. The mouse
controls its width and height exactly as before, distance to the
...
The real challenge of this second project is that you have already
solved every sub-problem once. So try to build the rect tool with
as few looks at the sample solution as possible, ideally none at all.
