...
1. **Paper first.** Sketch the 400 by 200 canvas and mark the center at
   (200, 100). Pick two mouse positions, for example (130, 45) and
   (330, 180), and compute both diameters for each by hand: subtract,
   `abs`, double, and, for the polished tool, snap to 20. Write down the
   area you expect.
...
3. **Peek with a rule.** The playground shows a sample solution for this
