...
variable. Treat this as a cliffhanger, left open on purpose. What a
function really is, what the line with the parentheses means, and
how you write functions of your own is a big enough story that a
later part of this book is dedicated to it. Until then, signatures
like this one are always given, and your job is only the body:
